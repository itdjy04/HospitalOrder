...
import edu.jssvc.dao.OrderRecordsDao;
...
public class OrderRecordsServiceImpl implements OrderRecordsService {
	...
	public int countAllOrders(String hospitalName, String officesName, String doctorName,
		...
		return orderRecordsDao.countAllOrders(hospitalName, officesName, doctorName, isSuccess, isCancel, orderVer);
	}
	...
	public List<OrderRecords> findAllOrders(String hospitalName, String officesName, String doctorName,
		...
		return orderRecordsDao.findAllOrders(hospitalName, officesName, doctorName, isSuccess, isCancel, orderVer, start, size);
	}

	@Override
	public int approveOrder(int id) {
		return orderRecordsDao.approveOrder(id);
	}

	@Override
	public int rejectOrder(int id) {
		return orderRecordsDao.rejectOrder(id);
	}
