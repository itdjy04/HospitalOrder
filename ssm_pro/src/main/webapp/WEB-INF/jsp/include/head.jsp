...
<nav class="navbar navbar-inverse navbar-no-bg navbar-fixed-top"
	...
	<div class="container">
		...
		<div style="position: absolute; left: 150px; top: -2px;">
			<a class="navbar-brand" href="<c:url value="/index" />"><font color="#fff">苏州市医院预约挂号系统</font></a>
		</div>
			...
			<ul class="nav navbar-nav navbar-right">
				<li><span class="li-text"></span> <span class="li-text">
					...
					<div>
						...
						<c:if test="${userInfo.userIdenf != null}">
							<a class="navbar-brand" style="font-size: 12px;" href="/ssm_pro/userCenter"><strong><font color="#fff">欢迎您,${userInfo.userName }<c:if test="${userInfo.isAdmin == 1}">[管理员]</c:if></font></strong></a>
							<a class="navbar-brand" style="font-size: 12px;"
